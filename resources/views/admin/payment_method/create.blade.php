        ...
        <div class="flex flex-wrap -m-4">
            <div class="w-full md:w-1/2 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('name') invalid @enderror" placeholder="Bank Pembangunan Daerah Kalimantan Selatan" name="name" value="{{ old('name') }}" require>
                    @error('name')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror 
                </div>
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('short_name') invalid @enderror" placeholder="BPD KALSEL" name="short_name" value="{{ old('short_name') }}" require>
                    @error('short_name')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror 
                </div>
        ...
        <div class="flex flex-wrap -m-4">
            <div class="w-full md:w-1/2 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('detail_1') invalid @enderror" placeholder="Bank Kalsel" name="detail_1" value="{{ old('detail_1') }}" require>
                    @error('detail_1')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror 
                </div>
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('detail_2') invalid @enderror" placeholder="123 456 xxx" name="detail_2" value="{{ old('detail_2') }}" require>
                    @error('detail_2')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror 
                </div>
        ...
        <div class="flex flex-wrap -m-4">
            <div class="w-full md:w-1/2 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('detail_3') invalid @enderror" placeholder="Berkah Media Kreatif" name="detail_3" value="{{ old('detail_3') }}" require>
                    @error('detail_3')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror 
                </div>
