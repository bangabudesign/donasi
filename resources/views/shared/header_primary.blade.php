<header class="fixed w-full bg-white shadow z-40">
    <div class="w-full container mx-auto p-4 h-16 md:h-20 flex items-center justify-between">
        ...
        <div class="text-center md:text-left font-bold text-2xl">
            <a href="/"><img src="/images/logo-colored.png" class="h-12"></a>
        </div>
        ...
        <nav id="navigation" class="navigation">
            <ul>
                <div class="mobile-logo"><a href="`/`"><img src="/images/logo-colored.png" class="h-12 mx-auto"></a></div>
                ...
                <li class="w-full md:w-auto"><a href="{{ route('register') }}" class="inline-block w-full px-8 py-3 rounded text-center font-bold text-sm uppercase bg-orange-500 text-white hover:bg-orange-400 md:ml-2">Daftar</a></li>
                @endguest
                @auth
                <li class="w-full md:w-auto"><a href="{{ route('logout') }}" class="inline-block w-full px-8 py-3 rounded text-center font-bold text-sm uppercase bg-orange-500 text-white hover:bg-orange-400 md:ml-2"
