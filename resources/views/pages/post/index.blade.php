...
@section('content')
<div class="heading bg-orange-300">
    <div class="container mx-auto px-4 py-10">
        <h1 class="text-4xl font-bold leading-snug mb-2">Ada Apa Hari Ini?</h1>
        <p>Cerita ummat, berita seru, dan info terbaru. Baca semua artikel di sini.</p>
    </div>
</div>
<!-- content -->
<div class="container mx-auto px-4 py-10">
